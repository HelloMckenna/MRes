...
# > Master_list
#                         Species                 Common  Code    Group
# 1                   Alosa alosa             Allis shad  AAS     6
# 2        Engraulis encrasicolus                Anchovy  ANE     6
# 3           Lophius piscatorius             Anglerfish  MON     7
# 4            Trisopterus luscus                    Bib  BIB     4
# 5       Spondyliosoma cantharus         Black seabream  BKS     4
# 6                Raja brachyura             Blonde ray  BLR     3
# 7     Helicolenus dactylopterus     Blue-mouth redfish  RBM     7
# 8              Molva dypterygia              Blue ling  BLI     2
# 9      Micromesistius poutassou           Blue whiting  WHB     5
# 10                 Gadus morhua                    Cod  COD     4
# 11                  Molva molva            Common ling  LIN     2
# 12             Leucoraja naevus             Cuckoo ray  CUR     3
# 13              Limanda limanda                    Dab  DAB     3
# 14           Platichthys flesus               Flounder  FLE     3
# 15         Lepidorhombus boscii       Four spot megrim  LBI     3
# 16         Enchelyopus cimbrius     Fourbeard rockling  FRR     2
# 17              Argentina silus     Great silver smelt  GSS     5
# 18            Phycis blennoides      Greater forkbeard  GFB     7
# 19           Eutrigla gurnardus           Grey gurnard  GUG     7
# 20     Melanogrammus aeglefinus                Haddock  HAD     4
# 21        Merluccius merluccius                   Hake  HKE     4
# 22    Hippoglossus hippoglossus                Halibut  HAL     3
# 23              Clupea harengus                Herring  HER     6
# 24          Trachurus trachurus         Horse-mackerel  HOM     6
# 25                   Zeus faber              John dory  JOD     4
# 26             Microstomus kitt             Lemon sole  LEM     3
# 27        Scyliorhinus canicula Lesser spotted dogfish  LSD     7
# 28          Dipturus oxyrinchus        Long-nose skate  LNS     3
# 29 Hippoglossoides platessoides         Long rough dab  PLA     3
# 30             Scomber scombrus               Mackerel  MAC     6
# 31   Lepidorhombus whiffiagonis                 Megrim  MEG     3
# 32        Pleuronectes platessa                 Plaice  PLE     3
# 33          Trisopterus minutus               Poor cod  POD     4
# 34           Chimaera monstrosa            Rabbit fish  RBF     4
# 35              Mullus barbatus             Red mullet  MBB     4
# 36            Pollachius virens                 Saithe  POK     4
# 37          Arnoglossus laterna             Scald fish  SDF     3
# 38         Dicentrarchus labrax                Seabass  ESB     5
# 39                  Solea solea                   Sole  SOL     1
# 40          Buglossidium luteum              Solenette  SOT     1
# 41                Raja montagui            Spotted ray  SDR     3
# 42            Sprattus sprattus                  Sprat  SPR     6
# 43            Squalus acanthias                Spurdog  DGS     5
# 44            Amblyraja radiata             Starry ray  SYR     3
# 45                 Raja clavata          Thornback ray  THR     3
# 46           Galeorhinus galeus             Tope shark  GAG     5
# 47         Scophthalmus maximus                 Turbot  TUR     3
# 48                Brosme brosme                   Tusk  USK     7
# 49                 Alosa fallax            Twaite shad  TAS     6
# 50         Merlangius merlangus                Whiting  WHG     4
# 51   Glyptocephalus cynoglossus                  Witch  WIT     3
...
gc()
Home <- "C:/Users/Hello.Mckenna/OneDrive - GMIT/__MRes Thesis/PACKAGE" 
setwd(Home)
...
Loops <- 1 # number of times estmiation is repeated in order to find an average
